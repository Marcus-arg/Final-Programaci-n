...
namespace ArchivoFinalProgramación
{
    public partial class Form2 : Form
    {
        ...
        public Form2()
        {
            ...
            // COMIENZO CARGA DE VARIABLES PROFESORES

            // Abrimos el archivo en modo lectura
            FileStream fs1 = new FileStream("Profesores.txt", FileMode.OpenOrCreate, FileAccess.Read);

            // Leeemos linea por línea y, por cada linea, cargamos en el data grid view
            ...
            // Cerramos el arcivo
            fs1.Close();
            // FIN CARGA DE VARIABLES PROFESORES


            // COMIENZO CARGA DE VARIABLES MATERIAS
        ...
        private void Guardar() {
            ...
            using (StreamWriter writer = new StreamWriter(fs2))
            {
                ...
                {
                    writer.WriteLine($"{row.Cells[0].Value}"); // Mismo codigo que para guardar profesores
                }
            }
            fs2.Close();
            //FIN PARA GUARDAR PROFESORES
